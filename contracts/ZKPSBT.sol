...
contract ZKPSBT is MasaSBTSelfSovereign, ReentrancyGuard {
    ...
    struct SBTData {
        bytes hashData; // hash of ownerAddress+sbtTokenId+creditScore without encryption, used to verify the data
    ...
    /// @param hashData Hash of ownerAddress+sbtTokenId+creditScore without encryption, used to verify the data
